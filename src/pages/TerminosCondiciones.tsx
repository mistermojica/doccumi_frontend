...
// Este sitio web es operado por Mojica Labs. En todo el sitio, los términos “nosotros”, “nos”, “nuestro” y “la empresa” se refieren a Mojica Labs. Mojica Labs ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
...
// Nuestra tienda se encuentra alojada en SamCart, LLC. Ellos nos proporcionan la plataforma de comercio electrónico en línea, que nos permite venderte nuestros productos y servicios.
...
// También es posible que, en el futuro, te ofrezcamos nuevos servicios y/o características a través del sitio web (incluyendo el lanzamiento de nuevas herramientas y recursos).  Estas nuevas caraterísticas y/o servicios también estarán sujetos a estos Términos de Servicio.
...
// Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Andres Julio Aybar 48, Piantini, Santo Domingo, 01, 01441, Dominican Republic.
...
// SECCIÓN 20 - DEVOLUCIONES, REEMBOLSOS Y CANCELACIONES

// No se realizarán reembolsos luego de entregados los archivos en formato PDF.

// SECCIÓN 21 - ENTREGA

// Todos los entregables de la comunidad se realizarán en formato PDF vía nuestro grupo de Facebook.

// SECCIÓN 22 - INFORMACIÓN DE CONTACTO

// Preguntas acerca de los Términos de Servicio deben ser enviadas a omar@omarmojica.com o llamando a nuestro número telefónico 809-379-0955.

// Nuestras oficinas se encuentran ubicadas en la calle La Vereda #10, Urb. Olimpo, Santo Domingo Oeste, República Dominicana