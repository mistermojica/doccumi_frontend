...
var _excluded2 = ["children", "count", "parent", "i18nKey", "tOptions", "values", "defaults", "components", "ns", "i18n", "t", "shouldUnescape"];
  ...
  function mapAST(reactNode, astNode, rootReactNode) {
    ...
    return astNodes.reduce(function(mem, node, i2) {
      ...
      if (node.type === "tag") {
        ...
        if (wrapTextNodes) {
          mem.push(import_react2.default.createElement(wrapTextNodes, {
            key: "".concat(node.name, "-").concat(i2)
          }, _content));
        } else {
          mem.push(_content);
...
function withTranslation(ns) {
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      ...
      var _useTranslation = useTranslation(ns, rest), _useTranslation2 = _slicedToArray(_useTranslation, 3), t2 = _useTranslation2[0], i18n = _useTranslation2[1], ready = _useTranslation2[2];
