import {
  _toConsumableArray
} from "./chunk-7DTR4KWG.js";
import {
  _objectWithoutProperties,
  _slicedToArray
} from "./chunk-QPKY35QH.js";
import {
  _inherits
} from "./chunk-TK5C5UI3.js";
import {
  _classCallCheck,
  _createClass,
  _typeof
} from "./chunk-COSV3MA7.js";
import {
  _defineProperty
} from "./chunk-IDEQTTU6.js";
...
var PortalPlacementContext = (0, import_react2.createContext)({
...
var LiveRegion = function LiveRegion2(props) {
  ...
  var messages = (0, import_react3.useMemo)(function() {
    return _objectSpread2(_objectSpread2({}, defaultAriaLiveMessages), ariaLiveMessages || {});
  }, [ariaLiveMessages]);
  var ariaSelected = (0, import_react3.useMemo)(function() {
    var message = "";
  ...
  var ariaFocused = (0, import_react3.useMemo)(function() {
    var focusMsg = "";
  ...
  var ariaResults = (0, import_react3.useMemo)(function() {
    var resultsMsg = "";
  ...
  var ariaGuidance = (0, import_react3.useMemo)(function() {
    var guidanceMsg = "";
  ...
  var ScreenReaderText = jsx(import_react3.Fragment, null, jsx("span", {
    id: "aria-selection"
  }, ariaSelected), jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === "initial-input-focus";
  return jsx(import_react3.Fragment, null, jsx(A11yText, {
    id
...
function useScrollCapture(_ref3) {
  ...
  var isBottom = (0, import_react3.useRef)(false);
  var isTop = (0, import_react3.useRef)(false);
  var touchStart = (0, import_react3.useRef)(0);
  var scrollTarget = (0, import_react3.useRef)(null);
  var handleEventDelta = (0, import_react3.useCallback)(function(event, delta) {
  ...
  var onWheel = (0, import_react3.useCallback)(function(event) {
    handleEventDelta(event, event.deltaY);
  }, [handleEventDelta]);
  var onTouchStart = (0, import_react3.useCallback)(function(event) {
    touchStart.current = event.changedTouches[0].clientY;
  }, []);
  var onTouchMove = (0, import_react3.useCallback)(function(event) {
    var deltaY = touchStart.current - event.changedTouches[0].clientY;
    handleEventDelta(event, deltaY);
  }, [handleEventDelta]);
  var startListening = (0, import_react3.useCallback)(function(el) {
    if (!el)
      return;
  ...
  var stopListening = (0, import_react3.useCallback)(function(el) {
    if (!el)
      return;
...
function useScrollLock(_ref3) {
  ...
  var originalStyles = (0, import_react3.useRef)({});
  var scrollTarget = (0, import_react3.useRef)(null);
  var addScrollLock = (0, import_react3.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM)
      return;
  ...
  var removeScrollLock = (0, import_react3.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM)
      return;
    var target = document.body;
    var targetStyle = target && target.style;
...
function ScrollManager(_ref3) {
  ...
  return jsx(import_react3.Fragment, null, lockEnabled && jsx("div", {
...
var Select = function(_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function renderMenu() {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? React.createElement(MenuPortal2, _extends({}, commonProps, {
...
function useAsync(_ref3) {
  ...
  var lastRequest = (0, import_react6.useRef)(void 0);
  var mounted = (0, import_react6.useRef)(false);
  var _useState = (0, import_react6.useState)(Array.isArray(propsDefaultOptions) ? propsDefaultOptions : void 0), _useState2 = _slicedToArray(_useState, 2), defaultOptions = _useState2[0], setDefaultOptions = _useState2[1];
  var _useState3 = (0, import_react6.useState)(typeof propsInputValue !== "undefined" ? propsInputValue : ""), _useState4 = _slicedToArray(_useState3, 2), stateInputValue = _useState4[0], setStateInputValue = _useState4[1];
  var _useState5 = (0, import_react6.useState)(propsDefaultOptions === true), _useState6 = _slicedToArray(_useState5, 2), isLoading = _useState6[0], setIsLoading = _useState6[1];
  var _useState7 = (0, import_react6.useState)(void 0), _useState8 = _slicedToArray(_useState7, 2), loadedInputValue = _useState8[0], setLoadedInputValue = _useState8[1];
  var _useState9 = (0, import_react6.useState)([]), _useState10 = _slicedToArray(_useState9, 2), loadedOptions = _useState10[0], setLoadedOptions = _useState10[1];
  var _useState11 = (0, import_react6.useState)(false), _useState12 = _slicedToArray(_useState11, 2), passEmptyOptions = _useState12[0], setPassEmptyOptions = _useState12[1];
  var _useState13 = (0, import_react6.useState)({}), _useState14 = _slicedToArray(_useState13, 2), optionsCache = _useState14[0], setOptionsCache = _useState14[1];
  var _useState15 = (0, import_react6.useState)(void 0), _useState16 = _slicedToArray(_useState15, 2), prevDefaultOptions = _useState16[0], setPrevDefaultOptions = _useState16[1];
  var _useState17 = (0, import_react6.useState)(void 0), _useState18 = _slicedToArray(_useState17, 2), prevCacheOptions = _useState18[0], setPrevCacheOptions = _useState18[1];
  ...
  var loadOptions = (0, import_react6.useCallback)(function(inputValue, callback) {
    if (!propsLoadOptions)
      return callback();
  ...
  var onInputChange = (0, import_react6.useCallback)(function(newValue, actionMeta) {
...
var AsyncSelect = (0, import_react7.forwardRef)(function(props, ref) {
...
// dep:react-select_async
var react_select_async_default = react_select_esm_default;
export {
  react_select_async_default as default,
  useAsync
};
