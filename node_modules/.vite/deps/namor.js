...
var require_data = __commonJS({
  "node_modules/namor/dist/_data.js"(exports, module) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
...
var require_utils = __commonJS({
  "node_modules/crypto-extra/dist/utils.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
...
var require_hash = __commonJS({
  "node_modules/crypto-extra/dist/hash.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    ...
    function hash(value, options) {
      ...
      var hash2 = "" + parsedValue + (options.salt || "");
      for (var i = 0; i < rounds; i++) {
        hash2 = crypto_1["default"].createHash(algorithm).update(hash2).digest("hex");
      }
      return hash2;
    }
    exports.hash = hash;
...
var require_encryption = __commonJS({
  "node_modules/crypto-extra/dist/encryption.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
var require_random = __commonJS({
  "node_modules/crypto-extra/dist/random.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    exports.__esModule = true;
    ...
    function randomNumber(options) {
      ...
      var random = integer / 3402823669209385e23;
...
var require_dist = __commonJS({
  "node_modules/crypto-extra/dist/index.js"(exports, module) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    var __importDefault = exports && exports.__importDefault || function(mod) {
    ...
    var crypto_1 = __importDefault(require_crypto());
    var hash = __importStar(require_hash());
    var encryption = __importStar(require_encryption());
...
var require_generate = __commonJS({
  "node_modules/namor/dist/generate.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    var __importDefault = exports && exports.__importDefault || function(mod) {
    ...
    exports.__esModule = true;
    var crypto_extra_1 = __importDefault(require_dist());
    var _data_1 = __importDefault(require_data());
    var Word;
    (function(Word2) {
      Word2["Adjective"] = "adjectives";
      Word2["Noun"] = "nouns";
      Word2["Verb"] = "verbs";
    })(Word || (Word = {}));
    ...
    function default_1(opts) {
      ...
      opts.words = Number(opts.words !== void 0 ? opts.words : 2);
      opts.saltType = opts.saltType || "mixed";
      opts.saltLength = Number(opts.saltLength !== void 0 ? opts.saltLength : 5);
...
var require_validate = __commonJS({
  "node_modules/namor/dist/validate.js"(exports) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
var require_dist2 = __commonJS({
  "node_modules/namor/dist/index.js"(exports, module) {
    "use strict";
    init_virtual_process_polyfill();
    init_buffer();
    var __importDefault = exports && exports.__importDefault || function(mod) {
    ...
    var _data_1 = __importDefault(require_data());
    var generate_1 = __importDefault(require_generate());
...
init_virtual_process_polyfill();
init_buffer();
var namor_default = require_dist2();
export {
  namor_default as default
};
//# sourceMappingURL=namor.js.map
