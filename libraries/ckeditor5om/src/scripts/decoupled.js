...
const placeHolderFields = [
  'No. de Registro y Placa',
  'Chasis',
  'Status del Vehículo',
  'Tipo de Emisión',
  'Tipo de Vehículo',
  'Año de Fabricación : cdk1',
  'Marca',
  'Modelo',
  'Color',
  'Precio',
...
for (let index = 1; index <= 20; index += 1) {
  const numero = index < 10 ? '0'.concat(index) : index;
  const campo = 'Campo Adicional '.concat(numero);
  // placeHolderFields.push(campo);
}
